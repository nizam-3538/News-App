...
import { Bookmark, ExternalLink, MessageCircle, Smile, Frown, Meh, Clock, User, Sparkles, Trash2, CheckCircle2 } from "lucide-react";
import api from "../utils/api";

const NewsCard = ({ article, onOpenChat, isVaultView = false, onDeleteSuccess }) => {
  const {
    id,
    title,
    summary,
